...
We have conducted an initial analysis, and are following up by sharing potential missing cases with officials who will be able to identify if there is a reason for a case to lack an EP. This research will inform future iterations of this analysis, and could lead to the development of a routine set of reports analagous to those in use for the "frontend seam."
...
write.table(unique(vacols_decisions$BFCORLID), "../tmp/cases.txt", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
potentially_missing_eps <- filter(no_ep_decisions,
                                  BFMPRO != "HIS" | disposition == "Full Grant")
