...
remands <- query("select BFCORLID, BFKEY, BFDDEC from BRIEFF where BFDDEC >= date '2006-10-01' and BFDC between '1' and '9' and vacols.issue_cnt_remand(BFKEY) > 0 and BFAC in ('1', '3')")
